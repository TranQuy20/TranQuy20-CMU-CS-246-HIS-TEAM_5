...
public class UIApp extends javax.swing.JPanel {
    ...
    private void Calculator_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Calculator_ButtonActionPerformed
        ...
        if (comboBox.equals("Square")) {
            if (First_Label.equals("")) {
                Report.setText("[Error]: Please, input data into cell!");
                resultText.setText("Null!");
            } else if (!num1is) {
                Report.setText("[Error]: Please, input a number!");
                First_Label.setText("");
                resultText.setText("Error!");
            } else {
                double result = cal.SquareNumber(num1);
                resultText.setText(result + "");
            }
        }
